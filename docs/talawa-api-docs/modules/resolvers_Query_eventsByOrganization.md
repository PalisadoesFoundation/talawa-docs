...
[src/resolvers/Query/eventsByOrganization.ts:10](https://github.com/PalisadoesFoundation/talawa-api/blob/12ccdb6/src/resolvers/Query/eventsByOrganization.ts#L10)
