...
[src/env.ts:2](https://github.com/PalisadoesFoundation/talawa-api/blob/4c7d3ea/src/env.ts#L2)
...
[src/env.ts:35](https://github.com/PalisadoesFoundation/talawa-api/blob/4c7d3ea/src/env.ts#L35)
