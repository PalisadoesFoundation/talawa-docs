...
[src/env.ts:3](https://github.com/PalisadoesFoundation/talawa-api/blob/12ccdb6/src/env.ts#L3)
...
[src/env.ts:36](https://github.com/PalisadoesFoundation/talawa-api/blob/12ccdb6/src/env.ts#L36)
