...
[src/env.ts:3](https://github.com/PalisadoesFoundation/talawa-api/blob/806e21a/src/env.ts#L3)
...
[src/env.ts:36](https://github.com/PalisadoesFoundation/talawa-api/blob/806e21a/src/env.ts#L36)
