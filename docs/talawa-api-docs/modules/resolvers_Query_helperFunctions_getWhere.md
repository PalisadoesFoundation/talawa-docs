...
[src/resolvers/Query/helperFunctions/getWhere.ts:26](https://github.com/PalisadoesFoundation/talawa-api/blob/4c7d3ea/src/resolvers/Query/helperFunctions/getWhere.ts#L26)
