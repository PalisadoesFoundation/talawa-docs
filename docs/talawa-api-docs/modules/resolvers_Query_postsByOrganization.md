...
[src/resolvers/Query/postsByOrganization.ts:13](https://github.com/PalisadoesFoundation/talawa-api/blob/12ccdb6/src/resolvers/Query/postsByOrganization.ts#L13)
