...
> `optional` **createActionItemCategory**: [`Resolver`](Resolver.md)\<[`ResolversTypes`](ResolversTypes.md)\[`"ActionItemCategory"`\], `ParentType`, `ContextType`, [`RequireFields`](RequireFields.md)\<[`MutationCreateActionItemCategoryArgs`](MutationCreateActionItemCategoryArgs.md), `"name"` \| `"organizationId"`\>\>
...
[src/types/generatedGraphQLTypes.ts:4302](https://github.com/PalisadoesFoundation/talawa-api/blob/3bacbf38707ebd3e3e5f1bc5b4cc7aa3b2adc169/src/types/generatedGraphQLTypes.ts#L4302)
