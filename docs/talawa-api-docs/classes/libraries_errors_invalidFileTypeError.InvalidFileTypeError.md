...
[src/libraries/errors/invalidFileTypeError.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/53234da/src/libraries/errors/invalidFileTypeError.ts#L6)
