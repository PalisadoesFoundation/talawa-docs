...
[src/libraries/errors/invalidFileTypeError.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/4c7d3ea/src/libraries/errors/invalidFileTypeError.ts#L6)
