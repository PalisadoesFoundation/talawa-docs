...
[src/libraries/errors/invalidFileTypeError.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/fa10711/src/libraries/errors/invalidFileTypeError.ts#L6)
