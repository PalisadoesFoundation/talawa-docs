...
[src/libraries/errors/unauthenticatedError.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/fa10711/src/libraries/errors/unauthenticatedError.ts#L6)
