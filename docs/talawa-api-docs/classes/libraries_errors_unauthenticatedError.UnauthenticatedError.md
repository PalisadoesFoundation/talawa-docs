...
[src/libraries/errors/unauthenticatedError.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/a731ade/src/libraries/errors/unauthenticatedError.ts#L6)
