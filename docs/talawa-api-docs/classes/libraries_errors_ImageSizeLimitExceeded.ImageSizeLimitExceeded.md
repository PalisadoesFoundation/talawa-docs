...
[src/libraries/errors/ImageSizeLimitExceeded.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/e919df4/src/libraries/errors/ImageSizeLimitExceeded.ts#L6)
