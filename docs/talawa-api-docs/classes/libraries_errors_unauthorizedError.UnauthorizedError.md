...
[src/libraries/errors/unauthorizedError.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/a731ade/src/libraries/errors/unauthorizedError.ts#L6)
