...
[src/libraries/dbLogger.ts:37](https://github.com/PalisadoesFoundation/talawa-api/blob/d0c167bb942c4778fba221c2cdd27665fc7dbf61/src/libraries/dbLogger.ts#L37)
...
\> **$where**(`argument`): `Query`\<`T`[], `T`, `object`, `T`, `"find"`\>
...
\> **countDocuments**(`criteria`?, `options`?): `Query`\<`number`, `T`, `object`, `T`, `"countDocuments"`\>
...
`Query`\<`number`, `T`, `object`, `T`, `"countDocuments"`\>
...
\> **deleteMany**(`filter`?, `options`?): `Query`\<`any`, `T`, `object`, `T`, `"deleteMany"`\>
...
`Query`\<`any`, `T`, `object`, `T`, `"deleteMany"`\>
...
\> **deleteMany**(`filter`): `Query`\<`any`, `T`, `object`, `T`, `"deleteMany"`\>
...
\> **deleteMany**(): `Query`\<`any`, `T`, `object`, `T`, `"deleteMany"`\>
...
\> **deleteOne**(`filter`?, `options`?): `Query`\<`any`, `T`, `object`, `T`, `"deleteOne"`\>
...
`Query`\<`any`, `T`, `object`, `T`, `"deleteOne"`\>
...
\> **deleteOne**(`filter`): `Query`\<`any`, `T`, `object`, `T`, `"deleteOne"`\>
...
\> **deleteOne**(): `Query`\<`any`, `T`, `object`, `T`, `"deleteOne"`\>
...
\> **distinct**\<`DocKey`, `ResultType`\>(`field`, `filter`?): `Query`\<`DocKey` *extends* keyof `T` ? `Unpacked`\<`T`\[`DocKey`\<`DocKey`\>\]\> : `ResultType`[], `T`, `object`, `T`, `"distinct"`\>
...
`Query`\<`DocKey` *extends* keyof `T` ? `Unpacked`\<`T`\[`DocKey`\<`DocKey`\>\]\> : `ResultType`[], `T`, `object`, `T`, `"distinct"`\>
...
\> **estimatedDocumentCount**(`options`?): `Query`\<`number`, `T`, `object`, `T`, `"estimatedDocumentCount"`\>
...
`Query`\<`number`, `T`, `object`, `T`, `"estimatedDocumentCount"`\>
...
\> **find**(`filter`, `projection`?, `options`?): `Query`\<`T`[], `T`, `object`, `T`, `"find"`\>
...
\> **find**(`filter`, `projection`?): `Query`\<`T`[], `T`, `object`, `T`, `"find"`\>
...
\> **find**(`filter`): `Query`\<`T`[], `T`, `object`, `T`, `"find"`\>
...
\> **findById**(`id`, `projection`?, `options`?): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOne"`\>
...
`Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOne"`\>
...
\> **findById**(`id`, `projection`?): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOne"`\>
...
\> **findById**(`id`): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOne"`\>
...
\> **findByIdAndDelete**(`id`, `options`): `Query`\<`ModifyResult`\<`T`\>, `T`, `object`, `T`, `"findOneAndDelete"`\>
...
`Query`\<`ModifyResult`\<`T`\>, `T`, `object`, `T`, `"findOneAndDelete"`\>
...
\> **findByIdAndDelete**(`id`?, `options`?): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOneAndDelete"`\>
...
`Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOneAndDelete"`\>
...
\> **findByIdAndUpdate**(`id`, `update`, `options`): `Query`\<`any`, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
`Query`\<`any`, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
\> **findByIdAndUpdate**(`id`, `update`, `options`): `Query`\<`T`, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
`Query`\<`T`, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
\> **findByIdAndUpdate**(`id`?, `update`?, `options`?): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
`Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
\> **findByIdAndUpdate**(`id`, `update`): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
\> **findOne**(`filter`?, `projection`?, `options`?): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOne"`\>
...
\> **findOne**(`filter`?, `projection`?): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOne"`\>
...
\> **findOne**(`filter`?): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOne"`\>
...
\> **findOneAndDelete**(`filter`?, `options`?): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOneAndDelete"`\>
...
\> **findOneAndUpdate**(`filter`, `update`, `options`): `Query`\<`ModifyResult`\<`T`\>, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
`Query`\<`ModifyResult`\<`T`\>, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
\> **findOneAndUpdate**(`filter`, `update`, `options`): `Query`\<`T`, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
\> **findOneAndUpdate**(`filter`?, `update`?, `options`?): `Query`\<`null` \| `T`, `T`, `object`, `T`, `"findOneAndUpdate"`\>
...
\> **lean**\<`LeanResultType`\>(`val`?): `Query`\<`LeanResultType`, `T`, `object`, `T`, `"find"`\>
...
`Query`\<`LeanResultType`, `T`, `object`, `T`, `"find"`\>
...
• **source**: `Query`\<`any`, `any`, `object`, `any`, `"find"`\> \| `FilterQuery`\<`T`\>
...
\> **orFail**(`err`?): `Query`\<`object`, `T`, `object`, `T`, `"find"`\>
...
\> **populate**\<`Paths`\>(`path`, `select`?, `model`?, `match`?): `Query`\<keyof `Paths` *extends* `never` ? `unknown` : `Omit`\<`unknown`, keyof `Paths`\> & `Paths`, `T`, `object`, `UnpackedIntersection`\<`T`, `Paths`\>, `"find"`\>
...
`Query`\<keyof `Paths` *extends* `never` ? `unknown` : `Omit`\<`unknown`, keyof `Paths`\> & `Paths`, `T`, `object`, `UnpackedIntersection`\<`T`, `Paths`\>, `"find"`\>
...
\> **populate**\<`Paths`\>(`options`): `Query`\<keyof `Paths` *extends* `never` ? `unknown` : `Omit`\<`unknown`, keyof `Paths`\> & `Paths`, `T`, `object`, `UnpackedIntersection`\<`T`, `Paths`\>, `"find"`\>
...
\> **replaceOne**(`filter`?, `replacement`?, `options`?): `Query`\<`any`, `T`, `object`, `T`, `"replaceOne"`\>
...
`Query`\<`any`, `T`, `object`, `T`, `"replaceOne"`\>
...
\> **select**\<`RawDocTypeOverride`\>(`arg`): `Query`\<`IfEquals`\<`RawDocTypeOverride`, `object`, `unknown`, `IfAny`\<`RawDocTypeOverride`, `any`, `Document`\<`unknown`, `object`, `RawDocTypeOverride`\> & `Require_id`\<`RawDocTypeOverride`\>\>\>, `T`, `object`, `IfEquals`\<`RawDocTypeOverride`, `object`, `T`, `RawDocTypeOverride`\>, `"find"`\>
...
`Query`\<`IfEquals`\<`RawDocTypeOverride`, `object`, `unknown`, `IfAny`\<`RawDocTypeOverride`, `any`, `Document`\<`unknown`, `object`, `RawDocTypeOverride`\> & `Require_id`\<`RawDocTypeOverride`\>\>\>, `T`, `object`, `IfEquals`\<`RawDocTypeOverride`, `object`, `T`, `RawDocTypeOverride`\>, `"find"`\>
...
• **arg?**: `null` \| `string` \| `object` \| [`string`, `SortOrder`][]
...
\> **transform**\<`MappedType`\>(`fn`): `Query`\<`MappedType`, `T`, `object`, `T`, `"find"`\>
...
`Query`\<`MappedType`, `T`, `object`, `T`, `"find"`\>
...
\> **updateMany**(`filter`?, `update`?, `options`?): `Query`\<`UpdateWriteOpResult`, `T`, `object`, `T`, `"updateMany"`\>
...
`Query`\<`UpdateWriteOpResult`, `T`, `object`, `T`, `"updateMany"`\>
...
\> **updateOne**(`filter`?, `update`?, `options`?): `Query`\<`UpdateWriteOpResult`, `T`, `object`, `T`, `"updateOne"`\>
...
`Query`\<`UpdateWriteOpResult`, `T`, `object`, `T`, `"updateOne"`\>
