...
1. Make sure to read the relevant `Introduction` and `Applying` pages first.
    1. GitHub Externship:
        1. [Introduction](https://palisadoesfoundation.github.io/talawa-docs/docs/internships/github/github-introduction).
        1. [Application Guide](https://palisadoesfoundation.github.io/talawa-docs/docs/internships/github/github-application-process).
    1. GSoC:
        1. [Introduction](https://palisadoesfoundation.github.io/talawa-docs/docs/internships/gsoc/gsoc-introduction).
        1. [Application Guide](https://palisadoesfoundation.github.io/talawa-docs/docs/internships/gsoc/gsoc-application-process).
