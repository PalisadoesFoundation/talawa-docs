...
1. Introduce yourself on our *#introductions* slack channel. You can join our [Slack Channel using the link on the Talawa repository's home page README.md file](http://github.com/PalisadoesFoundation/talawa).
