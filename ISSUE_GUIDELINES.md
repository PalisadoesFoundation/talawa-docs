...
1. If the issue is already reported and not assigned to anyone and you are interested in working on the issue then:
   ...
   1. Ask our contributors to assign it to you in `#talawa-docs` slack channel.
1. We regularly review issues and add a [`no-issue-activity`](https://github.com/PalisadoesFoundation/talawa-docs/issues?q=is%3Aissue+is%3Aopen+label%3Ano-issue-activity) label to them. Use the issue comments to ask whether the assignee is still working on the issue, and if not, ask for the issue to be assigned to you.
...
1. Join our `#talawa-docs-github` channel for automatic issue and pull request updates
